...
# must test the block button. it kinda works. seems laggy. doesnt show well. # update will change block to be a timed event. So 
# once you click block then you will defend till the timer ends then you can move again. 
